...
export function AdminSidebar() {
  return (
    <aside className="eco-sidebar">
      ...
      <Link href="/admin" className="eco-sidebar__item eco-sidebar__item--active">
        <i className="ti ti-layout-dashboard"></i>
        Dashboard
      </Link>
      <Link href="/admin/produtos" className="eco-sidebar__item">
        <i className="ti ti-package"></i>
        Produtos
      </Link>
      <Link href="/admin/categorias" className="eco-sidebar__item">
        <i className="ti ti-category"></i>
        Categorias
      </Link>

      <div className="eco-sidebar__group-label">Sistema</div>
      <Link href="/admin/usuarios" className="eco-sidebar__item">
        <i className="ti ti-users"></i>
        Usuários
      </Link>
      <Link href="/admin/metricas" className="eco-sidebar__item">
        <i className="ti ti-chart-bar"></i>
        Métricas
      </Link>
      <Link href="/admin/configuracoes" className="eco-sidebar__item">
